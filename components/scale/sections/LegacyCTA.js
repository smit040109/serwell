      ...
      <div className="max-w-page mx-auto">
        ...
        >
          ...
          <div
            ...
            style={{ background: 'radial-gradient(circle, rgba(232,93,44,0.28) 0%, transparent 60%)' }}
          />
          ...
          <div className="relative md:col-span-7">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <Link
                href="/contact"
                className="group inline-flex items-center gap-3 bg-vc-ember text-pure-white font-medium eyebrow px-7 py-4 rounded-btn hover:bg-vc-amber transition-colors"
              >
                Start a project
          ...
          <div className="relative md:col-span-5 w-full aspect-square max-w-[480px] mx-auto">
            ...
            >
              ...
              <path d="M 200,160 L 235,180 L 235,220 L 200,240 L 165,220 L 165,180 Z" stroke="#E85D2C" strokeWidth="1.5" />
