...
const SiteSettingsSchema = new Schema({
  ...
  // ---- Phase 1-3 extended fields ----
  rotatingWords: { type: [String], default: ['digital systems', 'AI workflows', 'growth engines', 'future products'] },
  closingStatement: { type: String, default: "Let's build something you can rely on." },
  preloaderText: { type: String, default: 'DESIGNING EXPERIENCES' },
  cinematicVideoUrl: { type: String, default: '/video/intro.mp4' },
  cinematicPosterUrl: { type: String, default: '/video/intro-poster.jpg' },
  cinematicEnabled: { type: Boolean, default: true },
  introTypewriterText: { type: String, default: 'Welcome to the VayuCodes World' },
...
/* ============================================================
   HOW WE WORK STEPS — list CRUD
============================================================ */
const HowWeWorkStepSchema = new Schema({
  _id: { type: String, default: uuid },
...
/* ============================================================
   LEGAL PAGES — keyed upsert (key: 'privacy' | 'terms')
============================================================ */
...
/* ============================================================
   PAGE CONTENT — keyed upsert (key: 'why-us' | 'digital-marketing' ...)
============================================================ */
...
export const HowWeWorkStep = mongoose.models.HowWeWorkStep || mongoose.model('HowWeWorkStep', HowWeWorkStepSchema, 'how_we_work_steps')
export const FaqItem = mongoose.models.FaqItem || mongoose.model('FaqItem', FaqItemSchema, 'faq_items')
export const LegalPage = mongoose.models.LegalPage || mongoose.model('LegalPage', LegalPageSchema, 'legal_pages')
export const PageContent = mongoose.models.PageContent || mongoose.model('PageContent', PageContentSchema, 'page_content')
...
// Collections upserted by a unique key field (KEYED_UPSERT pattern)
